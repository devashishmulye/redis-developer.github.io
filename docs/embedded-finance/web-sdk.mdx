...
- Create a user using [Create User](rest-api#create-user) API (One Time)
- Get Eligibility of the user using [Get Eligibility](rest-api#get-eligibility) API (One time)
...
- [Webhook](rest-api#webhook) can be configured to get updates about the loan applications.
:::
...
1. [Android SDK | FinBox Documentation](https://docs.finbox.in/device-connect/android)
2. [React Native | FinBox Documentation](https://docs.finbox.in/device-connect/react-native)
3. [Cordova | FinBox Documentation](https://docs.finbox.in/device-connect/cordova)
