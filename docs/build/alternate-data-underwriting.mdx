...
Our products [DeviceConnect](/products/device-connect) and [BankConnect](/products/bank-connect) provides us the alternate data to underwrite.


* [DeviceConnect](/products/device-connect)
* [BankConnect](/products/bank-connect)
...
We get this alternate data using [DeviceConnect](/products/device-connect) (device data), [BankConnect](/products/bank-connect) (Bank Statements), GST Data and also transaction data from our partners.
