...
**Flexible Repayment** - Customers can pay the EMI before the due date. In [overdraft](/build/buy-now-pay-later-overdraft) the user may any amount above the minimum bill.
