...
<!-- ## What is the FinBox Startup Programme?
Our mission is to democratize financial services for the next billion Indians. We realized that the infrastructure for distribution and access to financial services in India is broken and we are fixing it one API at a time. Through FinBox Startup Programme, we want to support other early-stage FinTech companies who are building financial services and products for the next billion Indians.

### Eligibility
We wish to enable early-stage companies to seamlessly collect financial data, critical to building user-centric FinTech products. The programme is open to any early-stage startup that meets the following eligibility requirements:
...
### Benefit
The FinBox Startup Programme includes FinBox’s Startup Deal on BankConnect solution - Participating **startups receive $500*** in credit toward our monthly usage plan for up to 3 months as long as they meet our eligibility requirements.
...
Interested companies can apply [here](https://finbox.in/startup-programme/).

_* can vary based on affiliated accelerator and VC partners._


## Frequently Asked Questions
**How are the FB credits applied?** Credits are applied to your monthly bill as per usage bases, covering up to $500 in total usage up to 3 months. Any additional usage costs are not covered by the programme.

**How do I redeem the FinBox credits?** Eligible startups can apply directly to the FinBox Startup Programme.

**How do I find out if I’ve been accepted to the FinBox Startup Programme?** If you’ve been accepted to the programme, you’ll receive the status of the application via email with a welcome message and the next steps. If you haven’t received an email, you can also check in your FinBox Dashboard portal and look for a Startup Programme icon in the top right corner.

**Where can I view the credits applied to my FinBox account?** The Startup Programme credits are reflected in the Dashboard usage and billing page.
...
**What happens if I go over my total credit applied?** When you reach 80% of credits, you will get a reminder to upgrade it, failing which you will lose access once you exhaust your total credit received as part of the Startup Programme offer. 
...
**How do I know if my accelerator/incubator/VC firm has a relationship with FinBox?** Ask your programme manager to see if they participate in the FinBox Startup Programme. If they do not, you can request that they apply to become a partner. -->