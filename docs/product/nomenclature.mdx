...
**Tenure** - Tenure is the duration of repayment of a loan.

**Underwriting** - Underwriting is a process of determining the credit worthiness of a customer. It includes sharing of information and proofs for user authentication and risk-assessment.
...
**Alternate Data Underwriting** -  Underwriting using data other than data from credit bureaus. This includes device data, bank statement, GST data, cash-flow data, or any data available with the anchor platform.

**Adaptive Journey** - Borrowers are onboarded as per their creditworthiness. Premium borrowers will be onboarded in fewer steps. Thin-file customers will have the option to share more data through various ways to acquire the loan.
