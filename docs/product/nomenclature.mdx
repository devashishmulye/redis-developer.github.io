...
**FLDG - First Loan Default Guatantee** - FLDG is an arrangement in which a third party (such as FinBox) can compensate some of the losses of non performing loans.
