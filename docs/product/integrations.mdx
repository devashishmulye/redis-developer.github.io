...
* HCIN
    ...
    We provide credit score and our predictions to the lenders. Based on thier policy lenders lend money to the borrowers.
...
Using Account Aggregators we fetch the borrowers bank statement directly. Currently 5 banks are supported by account aggregators:
