...
The collection process often creates several hurdles for lenders. The process directly affects the gross recollected amount of the lender’s portfolio. A smooth, data-driven process ensures lower delinquency and reduced collection costs and high customer satisfaction. Collections are a crucial part of the lending lifecycle. A poorly implemented collections program can put an end to a credit program.

> Collections are a crucial part of the lending lifecycle. It can make or break a lending program.
...
Manual outreach for collections
- High costs
- Time intensive
...
## How FinBox enables easy repayment
 ...
 - eNACH integration and NACH presentation - description
 - Notification Reminders - description
 - Integrate repayment into our UI via various modes - description
 - Facilitate flexible repayment - description
 - We have a calling team
