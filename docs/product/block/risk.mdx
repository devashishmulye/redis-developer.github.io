...
* **Capability to Pay** - Users capability to pay is analysed based on their credit score, bank transactions, income and expenses, and other credit history.
* **Intent to Pay** - Based on borrowers' engagement on Anchor app and previous repayment history their intent to pay is detemined.
