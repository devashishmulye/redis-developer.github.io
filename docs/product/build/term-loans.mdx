...
FinBox [Term Loan](https://put_link_redirection_here) enables flexible small ticket loans to fulfill their working capital needs. It is a fully managed end-to-end lending journey. Through this offering, your customers can avail credit instantly.
...
2. **Repayment** - User can choose to pay the emi through the app or nach is presented for the emi deduction.

3. **Automatic deduction by NACH presentation** - NACH is presented for the emi deduction.

4. **Borrower can choose to repay before the due date via the app**
=======
