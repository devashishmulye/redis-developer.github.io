...
* The Loan amount is disbursed within 24-48 hours
* The loans are non-collateralised.
* The user is given multiple Repayment plans.
* Customers can pay the EMI before the due date.
...
<ImageRow
 images={[
     ...
     {
         img:"/img/get_business_loan_screen.png",
         subtext:"A platform offering Business Loan"
     },
     {
