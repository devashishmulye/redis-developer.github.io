...
FinBox Buy-Now, Pay-Later Overdraft stack enables you to build and offer BNPL at checkout inside your platform. It is a fully managed end-to-end lending journey. Through this offering, your customers can activate an overdraft account and start purchasing on credit instantly. User can borrow a loan as long as he maintains the minimum balance in the overdraft account.

This helps you improve your GMV, AOV, Wallet Share, CLTV, and customer acquisition

## About the BNPL Overdarft

* Buy-Now, Pay-Later is powered by an overdraft account (or a [credit line](/product/build/buy-now-pay-later))
* The Overdraft account is approved instantly.
...
* The user must maintain a minimum balance in the overdraft account and will be sent a monthly minimum bill.
* We support multiple repayment models, based on your customer demographic.
* The repayment tenure is flexible, based on your customer demographic.
