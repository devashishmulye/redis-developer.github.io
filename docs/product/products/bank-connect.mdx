...
<CenteredImage  imgSrc={"/img/netbanking.png" } text="Net Banking Interface for Uploading Bank Statement" imgWidth="35%"/>
<CenteredImage  imgSrc={"/img/manual_upload.png" } text="Manual Upload Interface for Uploading Bank Statement" imgWidth="35%"/>
<CenteredImage  imgSrc={"/img/account_aggregator.png" } text="Account Aggregator Interface for Uploading Bank Statement" imgWidth="35%"/>
