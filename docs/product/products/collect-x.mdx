...
:::tip CollectX compiles a report every two weeks before the EMI due dates to prioritize borrower accounts as per high, moderate and low risk
::: 
...
* **Lower Delinquency rates** - Identify risky borrowers before their loan due date and use targeted collection strategies.

* **Lower Cost of Collection** - Segment your borrowers based on their riskiness and allocate collection resources intelligently

* **Improve Repayment Success Rate** - Get recommended date for eNACH presentation for bounced payments.
