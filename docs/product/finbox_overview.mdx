...
<div class="col">
  <RedisCard
    ...
    description="Lower financial costs and improve business efficieny of your users"
  ...
  <RedisCard
    ...
    description="Integrate FinBox Embedded Finance products with a link only for pilot phase"
...
<div class="col">
 ...
 <div class="col">
    <RedisCard 
        ...
        description="Continuously assess borrowers' ability to repay loans with real-time analysis" 
