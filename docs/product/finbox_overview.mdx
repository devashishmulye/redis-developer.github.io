...
These are the componenets of a digital lending program. FinBox offers each of these as a part of it's end-to-end stack.
 ...
 - [**Loan Management**](product/block/loan-management) - Enables the complete automation of the entire loan pipeline
 - [**Collections**](product/block/collections) - Process repayment of loan
 - [**Reconciliation**](product/block/reconciliation) - Comparing the account balance and process recollection of pending EMIs
