...
We are at the intersection of cutting-edge technology and deep credit expertise. Our product suite includes -  
 ...
 - [**Credit Stack**](https://finbox.in/products/embedded-finance/) - We enable any company to launch a digital credit programme on their platform by leveraging our end-to-end credit infrastructure.
...
### Credit Products
 ...
 - [**Pay in N days**](/build/buy-now-pay-later-overdraft) 
 - [**Pay in N installments**](/build/buy-now-pay-later-overdraft) 
 - [**Khata Receivables Financing**](/build/buy-now-pay-later-overdraft) 
 - [**Closed Loop Invoice Financing**](/build/buy-now-pay-later-overdraft) 
 - [**Personal Loans**](/build/buy-now-pay-later-overdraft) 
 - [**Working Capital Loans**](/build/buy-now-pay-later-overdraft) 
...
### Risk Assessment Products
 ...
 - [**Alternative Data Underwriting Suite**](build/personal-loans) 
 - [**Collections Intelligence Suite**](build/personal-loans)
...
These are the componenets of a digital lending programme. FinBox offers each of these as a part of it's end-to-end stack.
 ...
 - [**Capital**](block/capital) - Capital (provided by a lender) to lend
...
<div class="col">
  <RedisCard
    ...
    description="Build your own credit programme by leveraging the FinBox Embedded Finance Platform"
